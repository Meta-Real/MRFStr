...
#define MRFSTR_SIMD_CHAR_MASK 63
#define MRFSTR_SIMD_CHAR_SHIFT 6

#if MRFSTR_THREADING
#define MRFSTR_THREAD_LIMIT (4194368 * MRFSTR_THREAD_COUNT - 1)
#define MRFSTR_THREAD_CHUNK (64 * MRFSTR_THREAD_COUNT)
#endif
...
#define MRFSTR_SIMD_CHAR_MASK 31
#define MRFSTR_SIMD_CHAR_SHIFT 5

#if MRFSTR_THREADING
#define MRFSTR_THREAD_LIMIT (2097184 * MRFSTR_THREAD_COUNT - 1)
#define MRFSTR_THREAD_CHUNK (32 * MRFSTR_THREAD_COUNT)
#endif

#define mrfstr_simd_set1_func _mm256_set1_epi8
#define mrfstr_simd_stream_func _mm256_stream_si256
#define mrfstr_simd_cmpneq_func _mm256_cmpneq_epi64_mask
#define mrfstr_simd_cmpeq_mask_func _mm256_cmpeq_epi8_mask

#else

typedef __m128i mrfstr_simd_block_t;

#define MRFSTR_SIMD_CHAR_MASK 15
#define MRFSTR_SIMD_CHAR_SHIFT 4

#if MRFSTR_THREADING
#define MRFSTR_THREAD_LIMIT (1048592 * MRFSTR_THREAD_COUNT - 1)
#define MRFSTR_THREAD_CHUNK (16 * MRFSTR_THREAD_COUNT)
#endif

#define mrfstr_simd_set1_func _mm_set1_epi8
#define mrfstr_simd_stream_func _mm_stream_si128
#define mrfstr_simd_cmpneq_func _mm_cmpneq_epi64_mask
#define mrfstr_simd_cmpeq_mask_func _mm_cmpeq_epi8_mask
